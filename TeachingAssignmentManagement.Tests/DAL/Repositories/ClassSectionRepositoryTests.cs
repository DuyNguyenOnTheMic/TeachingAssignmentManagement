...
namespace TeachingAssignmentManagement.DAL.Tests
{
    ...
    public class ClassSectionRepositoryTests
    {
        ...
        [TestMethod()]
        public void Get_Classes_In_Learn_Week_Not_Null_Test()
        {
            // Arrange
            int[] currentLearnWeek = Array.ConvertAll(listClassSection.First().learn_week.Split(','), int.Parse);

            // Act
            IEnumerable<class_section> query_classes = unitOfWork.ClassSectionRepository.GetClassesByTerm(termId);
            dynamic actionResult = unitOfWork.ClassSectionRepository.GetClassesInLearnWeek(query_classes, currentLearnWeek);
        ...
        [TestMethod()]
        public void Get_Classes_In_Learn_Week_Data_Is_Correct_Test()
        {
            // Arrange
            ...
            // Act
            IEnumerable<class_section> query_classes = unitOfWork.ClassSectionRepository.GetClassesByTerm(termId);
            dynamic actionResult = unitOfWork.ClassSectionRepository.GetClassesInLearnWeek(query_classes, currentLearnWeek).ToList();
            List<class_section> classSectionList = listClassSection.Where(c => c.learn_week == classSection.learn_week).ToList();
        ...
        [TestMethod()]
        public void Classes_In_Learn_Week_Data_Should_Be_IEnumerable_Test()
        {
            // Arrange
            class_section classSection = listClassSection.First();
            int[] currentLearnWeek = Array.ConvertAll(classSection.learn_week.Split(','), int.Parse);
        ...
        [TestMethod()]
        public void Classes_In_Learn_Week_Data_Index_at_0_Should_Not_Be_Null_Test()
        {
            // Arrange
            class_section classSection = listClassSection.First();
            int[] currentLearnWeek = Array.ConvertAll(classSection.learn_week.Split(','), int.Parse);
        ...
        [TestMethod()]
        public void Classes_In_Learn_Week_Data_Should_Be_Indexable_Test()
        {
            // Arrange
            class_section classSection = listClassSection.First();
            int[] currentLearnWeek = Array.ConvertAll(classSection.learn_week.Split(','), int.Parse);
        ...
        [TestMethod()]
        public void Get_Classes_In_Learn_Week_List_Should_Be_Not_Null_And_Equal_Test()
        {
            // Arrange
            class_section classSection = listClassSection.First();
            int[] currentLearnWeek = Array.ConvertAll(classSection.learn_week.Split(','), int.Parse);
            ...
            IEnumerable<class_section> query_classes = unitOfWork.ClassSectionRepository.GetClassesByTerm(termId);
            dynamic actionResult = unitOfWork.ClassSectionRepository.GetClassesInLearnWeek(query_classes, currentLearnWeek).ToList();
            List<class_section> query_classSection = listClassSection.Where(c => Array.Exists(c.learn_week.Split(','), element => currentLearnWeek.Contains(int.Parse(element)))).ToList();
        ...
        [TestMethod()]
        public void Term_Statistics_Data_Should_Be_IEnumerable_Test()
        {
            // Arrange
            bool isLesson = false;
        ...
        [TestMethod()]
        public void Term_Statistics_Data_Index_at_0_Should_Not_Be_Null_Test()
        {
            // Arrange
            bool isLesson = false;
        ...
        [TestMethod()]
        public void Term_Statistics_Data_Should_Be_Indexable_Test()
        {
            // Arrange
            bool isLesson = false;
        ...
        [TestMethod()]
        public void Get_Term_And_Major_Lesson_Statistics_Not_Null_Test()
        {
            // Arrange
            bool isLesson = true;
        ...
        [TestMethod()]
        public void Term_And_Major_Lesson_Statistics_Data_Should_Be_IEnumerable_Test()
        {
            // Arrange
            bool isLesson = true;
        ...
        [TestMethod()]
        public void Term_And_Major_Lesson_Statistics_Data_Index_at_0_Should_Not_Be_Null_Test()
        {
            // Arrange
            bool isLesson = true;
        ...
        [TestMethod()]
        public void Term_And_Major_Lesson_Statistics_Data_Should_Be_Indexable_Test()
        {
            // Arrange
            bool isLesson = true;
        ...
        [TestMethod()]
        public void Get_Term_And_Major_Lesson_Statistics_List_Should_Be_Not_Null_And_Equal_Test()
        {
            // Arrange
            bool isLesson = true;
        ...
        [TestMethod()]
        public void Get_Term_And_Major_Lesson_Statistics_Should_Order_By_Largest_To_Smallest_Test()
        {
            // Arrange
            bool isLesson = true;
            int previousSum = 0;
        ...
        [TestMethod()]
        public void Get_Term_Lesson_Statistics_Not_Null_Test()
        {
            // Arrange
            bool isLesson = true;
        ...
        [TestMethod()]
        public void Term_Lesson_Statistics_Data_Should_Be_IEnumerable_Test()
        {
            // Arrange
            bool isLesson = true;
        ...
        [TestMethod()]
        public void Term_Lesson_Statistics_Data_Index_at_0_Should_Not_Be_Null_Test()
        {
            // Arrange
            bool isLesson = true;
        ...
        [TestMethod()]
        public void Term_Lesson_Statistics_Data_Should_Be_Indexable_Test()
        {
            // Arrange
            bool isLesson = true;
        ...
        [TestMethod()]
        public void Get_Term_Lesson_Statistics_List_Should_Be_Not_Null_And_Equal_Test()
        {
            // Arrange
            bool isLesson = true;
        ...
        [TestMethod()]
        public void Term_Major_Subjects_Data_Index_at_0_Should_Not_Be_Null_Test()
        {
            // Act
            dynamic actionResult = unitOfWork.ClassSectionRepository.GetTermSubjects(termId, majorId, userId1);
        ...
        [TestMethod()]
        public void Get_Year_And_Major_Statistics_All_Not_Null_Test()
        {
            // Arrange
            term term = listTerm.First();
            int startYear = term.start_year;
            ...
            // Act
            dynamic actionResult = unitOfWork.ClassSectionRepository.GetYearStatisticsAll(isLesson, startYear, endYear, majorId);
        ...
        [TestMethod()]
        public void Year_And_Major_Statistics_All_Data_Should_Be_IEnumerable_Test()
        {
            // Arrange
            term term = listTerm.First();
            int startYear = term.start_year;
        ...
        [TestMethod()]
        public void Year_And_Major_Statistics_All_Data_Index_at_0_Should_Not_Be_Null_Test()
        {
            // Arrange
            term term = listTerm.First();
            int startYear = term.start_year;
        ...
        [TestMethod()]
        public void Year_And_Major_Statistics_All_Data_Should_Be_Indexable_Test()
        {
            // Arrange
            term term = listTerm.First();
            int startYear = term.start_year;
        ...
        [TestMethod()]
        public void Get_Year_Statistics_All_Not_Null_Test()
        {
            // Arrange
            term term = listTerm.First();
            int startYear = term.start_year;
            ...
            // Act
            dynamic actionResult = unitOfWork.ClassSectionRepository.GetYearStatisticsAll(isLesson, startYear, endYear, "-1");
        ...
        [TestMethod()]
        public void Year_Statistics_All_Data_Should_Be_IEnumerable_Test()
        {
            // Arrange
            term term = listTerm.First();
            int startYear = term.start_year;
        ...
        [TestMethod()]
        public void Year_Statistics_All_Data_Index_at_0_Should_Not_Be_Null_Test()
        {
            // Arrange
            term term = listTerm.First();
            int startYear = term.start_year;
        ...
        [TestMethod()]
        public void Year_Statistics_All_Data_Should_Be_Indexable_Test()
        {
            // Arrange
            term term = listTerm.First();
            int startYear = term.start_year;
        ...
        [TestMethod()]
        public void Get_Year_And_Major_Lesson_Statistics_All_Not_Null_Test()
        {
            // Arrange
            term term = listTerm.First();
            int startYear = term.start_year;
        ...
        [TestMethod()]
        public void Year_And_Major_Lesson_Statistics_All_Data_Should_Be_IEnumerable_Test()
        {
            // Arrange
            term term = listTerm.First();
            int startYear = term.start_year;
        ...
        [TestMethod()]
        public void Year_And_Major_Lesson_Statistics_All_Data_Index_at_0_Should_Not_Be_Null_Test()
        {
            // Arrange
            term term = listTerm.First();
            int startYear = term.start_year;
        ...
        [TestMethod()]
        public void Year_And_Major_Lesson_Statistics_All_Data_Should_Be_Indexable_Test()
        {
            // Arrange
            term term = listTerm.First();
            int startYear = term.start_year;
        ...
        [TestMethod()]
        public void Get_Year_And_Major_Lesson_Statistics_All_List_Should_Be_Not_Null_And_Equal_Test()
        {
            // Arrange
            term term = listTerm.First();
            int startYear = term.start_year;
        ...
        [TestMethod()]
        public void Get_Year_And_Major_Lesson_Statistics_All_Should_Order_By_Largest_To_Smallest_Test()
        {
            // Arrange
            term term = listTerm.First();
            int startYear = term.start_year;
        ...
        [TestMethod()]
        public void Get_Year_Lesson_Statistics_All_Not_Null_Test()
        {
            // Arrange
            term term = listTerm.First();
            int startYear = term.start_year;
        ...
        [TestMethod()]
        public void Year_Lesson_Statistics_All_Data_Should_Be_IEnumerable_Test()
        {
            // Arrange
            term term = listTerm.First();
            int startYear = term.start_year;
        ...
        [TestMethod()]
        public void Year_Lesson_Statistics_All_Data_Index_at_0_Should_Not_Be_Null_Test()
        {
            // Arrange
            term term = listTerm.First();
            int startYear = term.start_year;
        ...
        [TestMethod()]
        public void Year_Lesson_Statistics_All_Data_Should_Be_Indexable_Test()
        {
            // Arrange
            term term = listTerm.First();
            int startYear = term.start_year;
        ...
        [TestMethod()]
        public void Get_Year_Lesson_Statistics_All_List_Should_Be_Not_Null_And_Equal_Test()
        {
            // Arrange
            term term = listTerm.First();
            int startYear = term.start_year;
        ...
        [TestMethod()]
        public void Get_Year_Lesson_Statistics_All_Should_Order_By_Largest_To_Smallest_Test()
        {
            // Arrange
            term term = listTerm.First();
            int startYear = term.start_year;
        ...
        [TestMethod()]
        public void Get_Personal_Classes_In_Term_Not_Null_Test()
        {
            // Act
            dynamic actionResult = unitOfWork.ClassSectionRepository.GetPersonalClassesInTerm(termId, userId1);
        ...
        [TestMethod()]
        public void Get_Personal_Classes_In_Term_Data_Is_Correct_Test()
        {
            // Act
            dynamic actionResult = unitOfWork.ClassSectionRepository.GetPersonalClassesInTerm(termId, userId1).ToList();
        ...
        [TestMethod()]
        public void Personal_Classes_In_Term_Data_Should_Be_IEnumerable_Test()
        {
            // Act
            dynamic actionResult = unitOfWork.ClassSectionRepository.GetPersonalClassesInTerm(termId, userId1).ToList();
            int count = 0;
        ...
        [TestMethod()]
        public void Personal_Classes_In_Term_Data_Index_at_0_Should_Not_Be_Null_Test()
        {
            // Act
            dynamic actionResult = unitOfWork.ClassSectionRepository.GetPersonalClassesInTerm(termId, userId1).ToList();
        ...
        [TestMethod()]
        public void Personal_Classes_In_Term_Data_Should_Be_Indexable_Test()
        {
            // Act
            dynamic actionResult = unitOfWork.ClassSectionRepository.GetPersonalClassesInTerm(termId, userId1).ToList();
        ...
        [TestMethod()]
        public void Get_Personal_Classes_In_Term_List_Should_Be_Not_Null_And_Equal_Test()
        {
            // Act
            dynamic actionResult = unitOfWork.ClassSectionRepository.GetPersonalClassesInTerm(termId, userId1).ToList();
            List<class_section> query_classSection = listClassSection.Where(c => c.term_id == termId && c.lecturer_id == userId1).ToList();
        ...
        [TestMethod()]
        public void Get_Personal_Classes_In_Year_Not_Null_Test()
        {
            // Arrange
            term term = listTerm.First();
            int startYear = term.start_year;
            ...
            // Act
            dynamic actionResult = unitOfWork.ClassSectionRepository.GetPersonalClassesInYear(startYear, endYear, userId1);
        ...
        [TestMethod()]
        public void Get_Personal_Classes_In_Year_Data_Is_Correct_Test()
        {
            // Arrange
            term term = listTerm.First();
            int startYear = term.start_year;
            ...
            // Act
            dynamic actionResult = unitOfWork.ClassSectionRepository.GetPersonalClassesInYear(startYear, endYear, userId1).ToList();
            List<class_section> classSectionList = listClassSection.Where(c => c.lecturer_id == userId1).ToList();
        ...
        [TestMethod()]
        public void Personal_Classes_In_Year_Data_Should_Be_IEnumerable_Test()
        {
            // Arrange
            term term = listTerm.First();
            int startYear = term.start_year;
        ...
        [TestMethod()]
        public void Personal_Classes_In_Year_Data_Index_at_0_Should_Not_Be_Null_Test()
        {
            // Arrange
            term term = listTerm.First();
            int startYear = term.start_year;
        ...
        [TestMethod()]
        public void Personal_Classes_In_Year_Data_Should_Be_Indexable_Test()
        {
            // Arrange
            term term = listTerm.First();
            int startYear = term.start_year;
        ...
        [TestMethod()]
        public void Get_Personal_Classes_In_Year_List_Should_Be_Not_Null_And_Equal_Test()
        {
            // Arrange
            term term = listTerm.First();
            int startYear = term.start_year;
            ...
            // Act
            dynamic actionResult = unitOfWork.ClassSectionRepository.GetPersonalClassesInYear(startYear, endYear, userId1).ToList();
            List<class_section> query_classSection = listClassSection.Where(c => c.term.start_year == startYear && c.term.end_year == endYear && c.lecturer_id == userId1).ToList();
        ...
        [TestMethod()]
        public void Get_Personal_Classes_In_Term_Major_Order_By_Subject_Not_Null_Test()
        {
            // Act
            dynamic actionResult = unitOfWork.ClassSectionRepository.GetPersonalClassesInTermOrderBySubject(termId, majorId, userId1);
        ...
        [TestMethod()]
        public void Get_Personal_Classes_In_Term_Major_Order_By_Subject_Data_Is_Correct_Test()
        {
            // Act
            dynamic actionResult = unitOfWork.ClassSectionRepository.GetPersonalClassesInTermOrderBySubject(termId, majorId, userId1).ToList();
            List<class_section> classSectionList = listClassSection.Where(c => c.lecturer_id == userId1).ToList();
        ...
        [TestMethod()]
        public void Personal_Classes_In_Term_Major_Order_By_Subject_Data_Should_Be_IEnumerable_Test()
        {
            // Act
            dynamic actionResult = unitOfWork.ClassSectionRepository.GetPersonalClassesInTermOrderBySubject(termId, majorId, userId1).ToList();
            int count = 0;
        ...
        [TestMethod()]
        public void Personal_Classes_In_Term_Major_Order_By_Subject_Data_Index_at_0_Should_Not_Be_Null_Test()
        {
            // Act
            dynamic actionResult = unitOfWork.ClassSectionRepository.GetPersonalClassesInTermOrderBySubject(termId, majorId, userId1).ToList();
        ...
        [TestMethod()]
        public void Personal_Classes_In_Term_Major_Order_By_Subject_Data_Should_Be_Indexable_Test()
        {
            // Act
            dynamic actionResult = unitOfWork.ClassSectionRepository.GetPersonalClassesInTermOrderBySubject(termId, majorId, userId1).ToList();
        ...
        [TestMethod()]
        public void Get_Personal_Classes_In_Term_Major_Order_By_Subject_List_Should_Be_Not_Null_And_Equal_Test()
        {
            // Act
            dynamic actionResult = unitOfWork.ClassSectionRepository.GetPersonalClassesInTermOrderBySubject(termId, majorId, userId1).ToList();
            List<class_section> query_classSection = listClassSection.Where(c => c.term_id == termId && c.lecturer_id == userId1).ToList();
