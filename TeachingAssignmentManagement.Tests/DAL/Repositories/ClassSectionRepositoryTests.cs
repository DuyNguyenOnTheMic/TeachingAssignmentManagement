...
namespace TeachingAssignmentManagement.DAL.Tests
{
    ...
    public class ClassSectionRepositoryTests
    {
        ...
        public void Get_Personal_Term_Statistics_Not_Null_Test()
        {
            ...
            // Act
            dynamic actionResult = unitOfWork.ClassSectionRepository.GetPersonalTermStatistics(isLesson, termId, userId1);
        ...
        public void Get_Personal_Term_Statistics_Should_Order_By_Largest_To_Smallest_Test()
        {
            ...
            foreach (dynamic json in actionResult)
            {
                int currentSum = json.subject_hours;
                Assert.IsTrue(currentSum >= previousSum);
        ...
        [TestMethod()]
        public void Personal_Year_Statistics_Data_Should_Be_IEnumerable_Test()
        {
            // Arrange
            term term = listTerm.First();
            int startYear = term.start_year;
        ...
        [TestMethod()]
        public void Personal_Year_Statistics_Data_Index_at_0_Should_Not_Be_Null_Test()
        {
            // Arrange
            term term = listTerm.First();
            int startYear = term.start_year;
        ...
        [TestMethod()]
        public void Personal_Year_Statistics_Data_Should_Be_Indexable_Test()
        {
            // Arrange
            term term = listTerm.First();
            int startYear = term.start_year;
        ...
        [TestMethod()]
        public void Get_Personal_Year_Statistics_List_Should_Be_Not_Null_And_Equal_Test()
        {
            // Arrange
            term term = listTerm.First();
            int startYear = term.start_year;
        ...
        [TestMethod()]
        public void Get_Personal_Year_Statistics_Should_Order_By_Largest_To_Smallest_Test()
        {
            // Arrange
            term term = listTerm.First();
            int startYear = term.start_year;
        ...
        [TestMethod()]
        public void Get_Personal_Year_Lesson_Statistics_Not_Null_Test()
        {
            // Arrange
            term term = listTerm.First();
            int startYear = term.start_year;
        ...
        [TestMethod()]
        public void Personal_Year_Lesson_Statistics_Data_Should_Be_IEnumerable_Test()
        {
            // Arrange
            term term = listTerm.First();
            int startYear = term.start_year;
        ...
        [TestMethod()]
        public void Personal_Year_Lesson_Statistics_Data_Index_at_0_Should_Not_Be_Null_Test()
        {
            // Arrange
            term term = listTerm.First();
            int startYear = term.start_year;
        ...
        [TestMethod()]
        public void Personal_Year_Lesson_Statistics_Data_Should_Be_Indexable_Test()
        {
            // Arrange
            term term = listTerm.First();
            int startYear = term.start_year;
        ...
        [TestMethod()]
        public void Get_Personal_Year_Lesson_Statistics_List_Should_Be_Not_Null_And_Equal_Test()
        {
            // Arrange
            term term = listTerm.First();
            int startYear = term.start_year;
        ...
        [TestMethod()]
        public void Get_Personal_Year_Lesson_Statistics_Should_Order_By_Largest_To_Smallest_Test()
        {
            // Arrange
            term term = listTerm.First();
            int startYear = term.start_year;
