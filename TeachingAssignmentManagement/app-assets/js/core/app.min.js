window.colors = {
	...
	function (a, e, t) {
		...
		var o = t("html"),
			n = t("body"),
			s = "#4e5154";
		if (t.fn.dataTable && t.extend(t.fn.dataTable.ext.classes, {
			sFilterInput: "form-control",
			sLengthSelect: "form-select"
		}), t(a).on("load", (function () {
			var l = !1;
			(n.hasClass("menu-collapsed") || "true" === localStorage.getItem("menuCollapsed")) && (l = !0), "rtl" == t("html").data("textdirection") && (r = !0), setTimeout((function () {
				o.removeClass("loading").addClass("loaded")
			}), 1200), t.app.menu.init(l);
			...
			t('a[data-action="collapse"]').on("click", (function (a) {
				...
				if (o.hasClass("dark-layout")) var e = "#10163a";
				else e = "#fff";
				a.block({
			...
			})), t("input:disabled, textarea:disabled").closest(".input-group").addClass("disabled"), t(".main-menu-content").find("li.active").parents("li").addClass("sidebar-group-active"), "horizontal-menu" != n.data("menu") && !1 === l && t(".main-menu-content").find("li.active").parents("li").addClass("open");
			var i = t(".chartjs"),
				c = i.children("canvas").attr("height"),
				d = t(".main-menu");
			if (i.css("height", c), n.hasClass("boxed-layout") && n.hasClass("vertical-overlay-menu")) {
				var u = d.width(),
					h = t(".app-content").position().left - u;
				n.hasClass("menu-flipped") ? d.css("right", h + "px") : d.css("left", h + "px")
			}
			t(".char-textarea").on("keyup", (function (e) {
				! function (e, o) {
					...
					})(o) || e.value.length < n - 1 && (e.value = e.value.substring(0, n));
					t(".char-count").html(e.value.length), e.value.length > n ? (r.css("background-color", a.colors.solid.danger), l.css("color", a.colors.solid.danger), l.addClass("max-limit")) : (r.css("background-color", a.colors.solid.primary), l.css("color", s), l.removeClass("max-limit"))
				...
				a.hasClass("open") && (a.removeClass("open"), searchInputInputfield.val(""), searchInputInputfield.blur(), searchList.removeClass("show")), t(".app-content").removeClass("show-overlay")
			}));
			var p = e.getElementsByClassName("main-menu-content");
			p.length > 0 && p[0].addEventListener("ps-scroll-y", (function () {
			...
			e.querySelector(".select2-search__field").focus()
			...
			var l = e.querySelector(".drag-target"),
				i = "panright",
				c = "panleft";
			if (!0 === r && (i = "panleft", c = "panright"), t(l).length > 0) new Hammer(l).on(i, (function (a) {
				if (n.hasClass("vertical-overlay-menu")) return t.app.menu.open(), !1
			}));
			setTimeout((function () {
				var a, o = e.querySelector(".main-menu");
				t(o).length > 0 && ((a = new Hammer(o)).get("pan").set({
			...
			var d = e.querySelector(".sidenav-overlay");
			if (t(d).length > 0) new Hammer(d).on("tap", (function (a) {
				if (n.hasClass("vertical-overlay-menu")) return t.app.menu.hide(), !1
			}))
		}

		function u() {
			return o.hasClass("dark-layout") ? "dark-layout" : "light-layout"
		}
		t(e).on("click", ".menu-toggle, .modern-nav-toggle", (function (e) {
		...
		})), t("#main-menu-navigation").find('[href="' + a.location.pathname + '"]').parent().addClass("active"), t(".navigation").find("li").has("ul").addClass("has-sub"), t(a).resize((function () {
			...
			a.preventDefault();
			var e = t(this),
				o = e.closest(".form-password-toggle"),
				n = e,
				s = o.find("input");
			"text" === s.attr("type") ? (s.attr("type", "password"), feather && n.find("svg").replaceWith(feather.icons.eye.toSvg({
				class: "font-small-4"
			}))) : "password" === s.attr("type") && (s.attr("type", "text"), feather && n.find("svg").replaceWith(feather.icons["eye-off"].toSvg({
				class: "font-small-4"
			})))
		...
		})), t(a).on("pageshow", (function (e) {
			(event.persisted || void 0 !== a.performance && 2 === a.performance.navigation.type) && a.location.reload()
		})), t(".scroll-top").on("click", (function () {
			t("html, body").animate({
				scrollTop: 0
			}, 75)
		}));
		var h = o.attr("data-layout") ? o.attr("data-layout") : "light-layout";

		function p(a) {
			var n, s = t(".nav-link-style"),
				r = u(),
				l = a || r;
			(o.removeClass("semi-dark-layout dark-layout bordered-layout"), "dark-layout" === l) ? (o.addClass("dark-layout"), e.documentElement.style.setProperty("color-scheme", "dark"), s.find(".ficon").replaceWith(feather.icons.sun.toSvg({
				class: "ficon"
			})), (n = bootstrap.Tooltip.getInstance(s)) && n.dispose(), new bootstrap.Tooltip(s, {
				title: "Chế độ sáng",
				fallbackPlacements: ["bottom"]
			})) : (o.addClass("light-layout"), e.documentElement.style.setProperty("color-scheme", "light"), s.find(".ficon").replaceWith(feather.icons.moon.toSvg({
				class: "ficon"
			})), (n = bootstrap.Tooltip.getInstance(s)) && n.dispose(), new bootstrap.Tooltip(s, {
				title: "Chế độ tối",
				fallbackPlacements: ["bottom"]
		...
		t(".nav-link-style").on("click", (function () {
			var a = u(),
				e = "",
				o = localStorage.getItem(h + "-prev-skin", a);
			e = "dark-layout" !== a ? "dark-layout" : a === o ? "light-layout" : o || "light-layout", localStorage.setItem(h + "-prev-skin", a), localStorage.setItem(h + "-current-skin", e), p(e), t(".horizontal-menu .header-navbar.navbar-fixed").css({
				background: "inherit",
				"box-shadow": "inherit"
			}), t(".horizontal-menu .horizontal-menu-wrapper.header-navbar").css("background", "inherit")
		})), p(localStorage.getItem(h + "-current-skin")), t(".apptogglefullscreen").on("click", (function (a) {
			screenfull.isEnabled && screenfull.toggle()
		})), screenfull.on("change", (() => {
			screenfull.isFullscreen ? t(".apptogglefullscreen").find("i").toggleClass("feather-minimize feather-maximize") : t(".apptogglefullscreen").find("i").toggleClass("feather-maximize feather-minimize")
		}))
